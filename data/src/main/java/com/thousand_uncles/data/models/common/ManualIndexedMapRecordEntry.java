...
@MappedSuperclass
public abstract class ManualIndexedMapRecordEntry {
    ...
    @Column(name = "curr_wr_seconds", nullable = false, precision = 14, scale = 2)
    private BigDecimal curr_wr_seconds; // SmallInt usually maps to Short or Integer in Java

    @Column(name = "prev_wr_seconds", nullable = false, precision = 14, scale = 2)
    ...
    @Column(name = "stage_1_time_seconds", precision = 14, scale = 2)
    private BigDecimal stage_1_time_seconds;

    @Column(name = "stage_2_time_seconds", precision = 14, scale = 2)
    private BigDecimal stage_2_time_seconds;

    @Column(name = "stage_3_time_seconds", precision = 14, scale = 2)
    private BigDecimal stage_3_time_seconds;

    // Constructors
    @SuppressWarnings("unused")
    public ManualIndexedMapRecordEntry() {}
...
//    stage_3_time_seconds
    ...
    public String toString() {
        return
            ...
            "\"id\":" + id +
            ",\"map_name\":\"" + map_name +
            "\",\"curr_wr_seconds\":" + curr_wr_seconds +
            ",\"prev_wr_seconds\":" + prev_wr_seconds +
            ",\"proof_img_1_link\":\"" + proof_img_1_link +
            "\",\"proof_img_2_link\":\"" + proof_img_2_link +
            "\",\"proof_img_3_link\":\"" + proof_img_3_link +
            "\",\"proof_vid_link\":\"" + proof_vid_link +
            "\",\"stage_1_time_seconds\":" + stage_1_time_seconds +
            ",\"stage_2_time_seconds\":" + stage_2_time_seconds +
            ",\"stage_3_time_seconds\":" + stage_3_time_seconds +
            "}";
    }
}
