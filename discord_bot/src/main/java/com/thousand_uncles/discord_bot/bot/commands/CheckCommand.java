...
public class CheckCommand implements SlashCommand {
    ...
    public Mono<Void> handle(ChatInputInteractionEvent event){
        try {
            ...
            List<ManualIndexedMapRecordEntry> searchedMaps = mapRecordServiceProd.searchRecords(partialMapName, category);
    ...
    private Mono<Void> singleMapFoundResponse(ChatInputInteractionEvent event, ManualIndexedMapRecordEntry foundMap, String category){
        ...
        return event.reply()
                .withEphemeral(true)
                .withContent("Record for " + foundMap.getMap_name() + " - " + category + "%" + ":\n" +
